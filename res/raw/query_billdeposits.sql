...
ifnull(CATEGORY_V1.CATEGNAME, '') || ifnull(' : ' || SUBCATEGORY_V1.SUBCATEGNAME, '') AS CATEGSUBCATEGNAME,
...
ROUND( ( CASE BILLSDEPOSITS_V1.TRANSCODE WHEN 'Withdrawal' THEN -1 ELSE 1 END ) * BILLSDEPOSITS_V1.TRANSAMOUNT , 2 ) AS AMOUNT,
...
LEFT OUTER JOIN SUBCATEGORY_V1 ON BILLSDEPOSITS_V1.SUBCATEGID =  SUBCATEGORY_V1.SUBCATEGID
LEFT OUTER JOIN INFOTABLE_V1 DF ON DF.INFONAME = 'DATEFORMAT',
ACCOUNTLIST_V1
