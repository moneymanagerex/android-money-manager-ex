...
public class QueryAccountBills extends Dataset {
	...
	"SELECT ACCOUNTLIST_V1.ACCOUNTID AS _id, ACCOUNTLIST_V1.ACCOUNTID, ACCOUNTNAME, STATUS, FAVORITEACCT, CURRENCYID, (INITIALBAL + T1.TOTAL) AS TOTAL " + 
	"FROM ACCOUNTLIST_V1, ( " + 
	...
	public String[] getAllColumns() {
		return new String[] {"ACCOUNTID AS _id", "ACCOUNTID", "ACCOUNTNAME", "STATUS", "FAVORITEACCT", "CURRENCYID", "TOTAL"};
	}
	/**
