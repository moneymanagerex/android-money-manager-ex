...
public class PreferencesConstant {
    ...
    public static final String PREF_DISABLE_PASSCODE = "disablepasscode";
    public static final String PREF_ACTIVE_PASSCODE = "activepasscode";
    public static final String PREF_DROPBOX_LINK = "dropbox2link";
