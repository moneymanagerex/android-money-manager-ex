...
public abstract class AbstractChart {
	 ...
	 */
	protected void setChartSettings(Context context, XYMultipleSeriesRenderer renderer, String title,
		...
		renderer.setMarginsColor(context.getResources().getColor(core.resolveIdAttribute(R.attr.theme_background_color)));
