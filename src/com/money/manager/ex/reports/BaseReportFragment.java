        ...
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                ...
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        ...
                        String whereClause = ViewMobileData.Date + ">='" + DateUtils.getSQLiteStringDate(getActivity(), mFromDate) + "' AND " +
                                ViewMobileData.Date + "<='" + DateUtils.getSQLiteStringDate(getActivity(), mToDate) + "'";
                        //compose bundle
                        Bundle args = new Bundle();
                        args.putString(KEY_WHERE_CLAUSE, whereClause);
                        //starts loader
