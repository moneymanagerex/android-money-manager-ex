...
public class SummaryOfAccountsChartActivity extends MmxBaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fm.findFragmentById(R.id.fragmentMain) == null) {
            SummaryOfAccountsChartFragment fragment = new SummaryOfAccountsChartFragment();
            fragment.setArguments(getIntent().getExtras());
            fm.beginTransaction()
                    .replace(R.id.fragmentMain, fragment, SummaryOfAccountsChartFragment.class.getSimpleName())
                    .commit();
        }
    }
