...
public class RobotoEditTextFontIcon extends AppCompatEditText {
     ...
     */
    public RobotoEditTextFontIcon(Context context) {
        super(context);
    }
     ...
     */
    public RobotoEditTextFontIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public RobotoEditTextFontIcon(Context context, AttributeSet attrs, int defStyle) {
