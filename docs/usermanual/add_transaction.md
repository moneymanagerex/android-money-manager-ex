...
# Transaction
What is a Transaction in <a href="/">MoneyManagerEx for Android</a>? A transaction is any money movement, including transfers, withdrawals, and deposits.
...
Finally, press the "Ok" button to save. If you want to abort the transaction, press "Abort".

If you want to edit, delete, or modify a transaction, hold on the desired transaction. Then a context menu with the available operations will open.
